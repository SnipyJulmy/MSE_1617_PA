        ...
        \digraph[scale=0.5]{GraphBaseModel}{
               node [shape=record];
                graph [rankdir=LR, 
                       ranksep="1", 
                       nodesep="1"];
                AndGate [label="{{<a>io.a|<b>io.b}|AndGate|{<c>io.c}}"];
                OrGate [label="{{<a>io.a|<b>io.b}|OrGate|{<c>io.c}}"];
                Input [label="{Input|{<a>io.a|<b>io.b}}"];
                Output [label="{{<c>io.c}|Output}"];
                Input:a -> AndGate:a [label="Bool"];
                Input:b -> AndGate:b [label="Bool"];
                Input:a -> OrGate:a [label="Bool"];
                Input:b -> OrGate:b [label="Bool"];
                OrGate:c -> Output:c [label="Bool"];
                AndGate:c -> Output:c [label="Bool"];
        }
    }
