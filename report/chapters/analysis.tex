...
\begin{figure}[] %{{{
    ...
    \begin{tikzpicture}
        ...
        \umlactor[x=14,y=2,name=spinal]{SpinalHDL}

        \begin{umlsystem}[x=2,y=0]{KlugHDL}
            \umlusecase[x=5,y=4,name=UCA]{Generate a component diagram}
            \umlusecase[x=5,y=3,name=UCB]{View a component diagram}
            \umlusecase[x=5,y=2,name=UCC]{Display, hide and toggle the hierarchical tree view of the programm}
            \umlusecase[x=5,y=1,name=UCD]{Filter the Hierarchical view}
            \umlusecase[x=5,y=0,name=UCE]{Enter a component}
            \umlusecase[x=5,y=-1,name=UCF]{Go out of a component}
            \umlusecase[x=5,y=-2,name=UCG]{Display, hide and toggle the view of the edge's type}
            \umlusecase[x=5,y=-3,name=UCH]{Generate the RTL}
        \end{umlsystem}
