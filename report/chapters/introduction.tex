...
The SpinalHDL language has been created to offer a more plaisant way to code in VHDL and this project is a contribution to these language as an additionnal tools, which gravited around the language itself.
