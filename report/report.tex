...
\chapter{Listings}
    ...
    \javafile{../GraphstreamTest/src/Main.java}
    \captionof{listing}{Implementation of the base graph model using Graphstream
    \label{lst:graphstream-test}}
...
\input{chapters/facts-sheets/display_edge_type}

\chapter{Facts sheet : Hide the type of some edge}
\input{chapters/facts-sheets/hide_edge_type}

\chapter{Facts sheet : Enter a component}
\input{chapters/facts-sheets/enter_inside_component}

\chapter{Facts sheet : Exit a component}
\input{chapters/facts-sheets/exit_from_component}

\chapter{Facts sheet : Go to the matching component from the source file}
\input{chapters/facts-sheets/goto_component_from_file}

\chapter{Facts sheet : Go to the matching code from a component}
\input{chapters/facts-sheets/goto_line_from_diagram}
...
\input{chapters/facts-sheets/zoom_inside_diagram}
